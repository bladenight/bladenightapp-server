...
import de.greencity.bladenightapp.server.rpchandlers.RpcHandlerGetAllRoutes;
...
public class BladenightWampServer extends WampServer {
	...
	protected void register() {
		...
		registerRpcHandler(BladenightUrl.GET_ALL_ROUTE_NAMES.getText(), 		new RpcHandlerGetAllRoutes(RouteStoreSingleton.getInstance()));
	}
